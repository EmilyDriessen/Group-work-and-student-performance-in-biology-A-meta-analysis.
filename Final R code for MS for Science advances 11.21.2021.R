...
##Datum 8 - Data MS Independent design data only
datum8=read.csv(file.choose())
...
##run random effects meta-analysis on dataset without paired research deisgn estimate (30 estimates) + author as random effect -  
results7=rma.mv(yi, vi, data=datum8, random =  ~ 1 |Author)
summary(results7)
